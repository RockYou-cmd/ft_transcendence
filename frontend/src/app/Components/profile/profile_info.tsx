	...
	return (
		<div className="m-8 flex flex-row gap-8 h-[88vh] font-bold ">
			...
			<div className="gap-5 w-full h-full grid grid-cols-3  grid-rows-4 xl:h-[100%] ">
				...
				<div className=" rounded-lg  col-span-2 row-span-3 bg-gray-800 sm:col-span-3 md:col-span-3 lg:col-span-3 xl:col-span-2 overflow-y-scroll scroll- shadow-sm shadow-cyan-500/50" >
